...
<div class="main-header">
    ...
    <p>Tác giả: Lộc Thị Soạn - Trường PTDTBT Tiểu học Du Già - ĐT: 097 6223 207207</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lộc Thị Soạn - Trường PTDTBT Tiểu học Du Già - ĐT: 097 6223 207</div>", unsafe_allow_html=True)
